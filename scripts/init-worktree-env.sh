...
postgres_db="hira_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://hira:hira@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
HIRA_SERVER_URL=ws://localhost:${backend_port}/ws
