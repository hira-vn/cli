...
type Task struct {
	...
	// KnowledgeContext is a pre-rendered markdown block of business-knowledge
	// chunks most relevant to this task (populated by the server when the
	// workspace has a published knowledge graph).
