...
import (
	...
	"github.com/hira-vn/cli/server/internal/logger"
...
type AgentTaskResponse struct {
	...
	// KnowledgeContext is pre-rendered markdown (top-K business knowledge
	// chunks) that the daemon writes to .agent_context/knowledge_context.md.
