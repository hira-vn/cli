...
const (
	...
	// Knowledge events
	EventKnowledgeDocCreated    = "knowledge:doc_created"
	EventKnowledgeDocUpdated    = "knowledge:doc_updated"
	EventKnowledgeDocDeleted    = "knowledge:doc_deleted"
	EventKnowledgeDocIndexing   = "knowledge:doc_indexing"
	EventKnowledgeDocIndexed    = "knowledge:doc_indexed"
