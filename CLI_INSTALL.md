...
```
Fetch https://github.com/hira-vn/cli/blob/main/CLI_INSTALL.md and follow the instructions to install Hira CLI, log in, and start the daemon on this machine.
```
...
LATEST=$(curl -sI https://github.com/hira-vn/cli/releases/latest | grep -i '^location:' | sed 's/.*tag\///' | tr -d '\r\n')

# Download and extract
curl -sL "https://github.com/hira-vn/cli/releases/download/${LATEST}/hira_${OS}_${ARCH}.tar.gz" -o /tmp/hira.tar.gz
